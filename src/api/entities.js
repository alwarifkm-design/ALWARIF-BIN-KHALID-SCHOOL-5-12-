...
export const Student = base44Client.entities.Student
export const Section = base44Client.entities.Section
export const Teacher = base44Client.entities.Teacher
